...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CourseCategory', fields ['slug']
        db.create_unique('core_coursecategory', ['slug'])

    def backwards(self, orm):
        # Removing unique constraint on 'CourseCategory', fields ['slug']
        db.delete_unique('core_coursecategory', ['slug'])
