...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_userprofile', 'profile_pic', self.gf('django.db.models.fields.files.ImageField')(default='x', max_length=100, blank=True), keep_default=False)

        # Adding field 'UserProfile.fb_profile_pic'
        db.add_column('core_userprofile', 'fb_profile_pic', self.gf('django.db.models.fields.URLField')(default='x', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.profile_pic'
        db.delete_column('core_userprofile', 'profile_pic')

        # Deleting field 'UserProfile.fb_profile_pic'
        db.delete_column('core_userprofile', 'fb_profile_pic')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'fb_profile_pic': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
