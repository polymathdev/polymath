...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.fb_profile_thumb'
        db.add_column('core_userprofile', 'fb_profile_thumb', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.fb_profile_thumb'
        db.delete_column('core_userprofile', 'fb_profile_thumb')
