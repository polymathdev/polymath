...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.photo'
        db.add_column('core_course', 'photo', self.gf('django.db.models.fields.files.ImageField')(default='x', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.photo'
        db.delete_column('core_course', 'photo')
